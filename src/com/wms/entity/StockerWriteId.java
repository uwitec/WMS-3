...
/**
 * StockerWriteId entity. @author MyEclipse Persistence Tools
 */

public class StockerWriteId implements java.io.Serializable {
	...
	/** default constructor */
	public StockerWriteId() {
	}

	/** minimal constructor */
	public StockerWriteId(String plcname) {
		this.plcname = plcname;
	}

	/** full constructor */
	public StockerWriteId(String plcname, String writeValue, String type,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StockerWriteId))
			return false;
		StockerWriteId castOther = (StockerWriteId) other;
