...
/**
 * ClreturnId entity. @author MyEclipse Persistence Tools
 */

public class ClreturnId implements java.io.Serializable {
	...
	/** minimal constructor */
	public ClreturnId(String plcname, String readValue) {
		this.plcname = plcname;
		this.readValue = readValue;
	}

	/** full constructor */
	public ClreturnId(String plcname, String readValue, String type,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ClreturnId))
			return false;
		ClreturnId castOther = (ClreturnId) other;
