...
<body class="sarchbody">
    ...
    <div class="formtitle"><span>库位查询</span></div>
	
	
    <ul class="seachform1"><form action="wareHouse!loctionQuery" method="post">
    <li><label>库位行</label><input name="name" type="text" class="scinput1"/></li>
    <li><label>库位列</label><input name="idCard" type="text" class="scinput1"/></li>
