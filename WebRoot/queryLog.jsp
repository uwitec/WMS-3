...
<body class="sarchbody">
    ...
    <ul class="seachform1"><form action="logTable!queryLog">
    <li><label>开始日期</label><input name="name" type="text" class="scinput1"/></li>
    <li><label>结束日期</label><input name="idCard" type="text" class="scinput1"/> </li>
    <li> <label>选择类型</label>
    <div class="vocation">
    <select class="select2" name="rank">
    <option value="正常">正常</option>
    <option value="堆垛机异常">堆垛机异常</option>
    </select>
    </div></li>
