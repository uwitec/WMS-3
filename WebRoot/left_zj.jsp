...
<body style="background:#fff3e1;">
    ...
    <dd>
    <div class="title"><span><img src="images/leftico01.png" /></span><a href="workStatus.jsp" target="rightFrame">作业状态</a></div> 
    </dd>
    ...
    <ul class="menuson">
      ...
      <dd><div class="title"><span><img src="images/leftico01.png" /></span><a href="tasklist.jsp" target="rightFrame">任务列表</a></div>
    <ul class="menuson">
